  ...
  app.post('/api/search_global', async (req, res) => {
    ...
    switch (type) {
      ...
      case "people":
        ...
        response = res.filter( u => { return u._id.toString() !== _id.toString()});
        break;
    }
    res.send(response);
  });
