...
// EDIT_HIGHLIGHT, FOCUS_SEARCH, ADDING_FOLDER, FETCH_HIGHLIGHTS } from '../actions/types';
//
// const initialState = { highlight: { number: null, id: null }, comment: "", start: "", stop: "", action: null, edit: null, searchKey: "", video: 0 };
//
// export default function ( state = initialState, action ){
//   switch (action.type) {
//     case FETCH_HIGHLIGHTS:            return { ...state, edit: null };
//     case ADDING_FOLDER:               return { ...state, edit: "folder" };
//     case FOCUS_SEARCH:                return { ...state, edit: "search" };
