...
POSTING_HIGHLIGHTS, EDIT, EDIT_ADD_LINK, EDIT_REMOVE_LINK, REMOVE_VIDEO, ADD_VIDEO, UPDATE_HIGHLIGHTS } from '../actions/types';

const initialState = { title: "", link: "", videos: [], editedVideos: [], creating: false, editing: false };
