import { FETCH_USER, CHANGE_TITLE, CHANGE_LINK, ADD_VIDEO_ID, POST_HIGHLIGHTS, REMOVE_LINK, NAV_NEW, CREATE, SELECT_HIGHLIGHTS, FETCH_HIGHLIGHTS,
POSTING_HIGHLIGHTS, EDIT, EDIT_ADD_LINK, EDIT_REMOVE_LINK, REMOVE_VIDEO, ADD_VIDEO, UPDATE_HIGHLIGHTS,CHANGE_DESCRIPTION, SET_DV,
CHANGE_FOLDER_NAME, FOCUS_SEARCH } from '../actions/types';
...
export default function ( state = initialState, action ){
  switch (action.type) {
    ...
    case FOCUS_SEARCH:              return { ...state, title: "" };
    case CHANGE_FOLDER_NAME:        return { ...state, title: action.payload };
