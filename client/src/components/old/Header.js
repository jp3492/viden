...
import { searchProject, selectHighlights, fetchHighlights, setSearch, navAdmin, changeView } from '../actions';
...
class Header extends React.Component {
  ...
  renderMenu(){
    const { history, fetchHighlights, search, auth, changeView } = this.props;
        ...
        <Drawer id="drawer" anchor="right" open={this.state.right} onClose={() => this.toggleDrawer(false)}>
          <div className="collection">
            ...
            <div
              ...
              onKeyDown={() => this.toggleDrawer(false)}
            >
            <a onClick={() => changeView("")} href="/api/logout">Logout</a>
            </div>
            {this.renderAdmin()}
          </div>
        </Drawer>
...
export default withStyles(styles)(connect(mapStateToProps, { searchProject, selectHighlights, fetchHighlights, setSearch, navAdmin, changeView })(Header));
